window.TurzxI18n = (() => {
  const translations = {
    en: {
      language:"Language",editor:"Editor",setup:"Setup",loading:"Loading…",startRendering:"Start rendering",stopRendering:"Stop rendering",
      ...
      currentConfiguration:"Current configuration",selectScreen:"Select a screen…",load:"Load",save:"Save",saveAs:"Save as",
      saveCurrentScreen:"Save the current screen",saveAsNewScreen:"Save as a new screen",
      new:"New",delete:"Delete",importPackage:"Import package",exportPackage:"Export package",sharePackage:"Share",
      quickScreens:"Quick screens",comPort:"COM port",comPlaceholder:"AUTO or COM3",refreshPorts:"Refresh COM ports",
      layers:"Layers",undo:"Undo",redo:"Redo",group:"Group",ungroup:"Ungroup",
      editorName:"Editor name",locked:"Locked",visible:"Visible",moveForward:"Move forward",moveBackward:"Move backward",
      weather:"Weather",enableWeather:"Enable weather data",latitude:"Latitude",longitude:"Longitude",weatherRefresh:"Refresh (minutes)",
      weatherHint:"Current conditions are cached locally. Coordinates use decimal degrees.",
      ...
      premiumEffects:"Premium effects",enableBootAnimation:"Enable boot animation",bootAnimation:"Boot animation",
      bootScreen:"Boot screen",bootHold:"Boot screen hold (ms)",
      bootForge:"Forge core",bootScanlines:"Scanlines",bootFade:"Fade in",bootDuration:"Boot duration (ms)",
      premiumEffectsHint:"Boot animation runs once during Windows autostart. Manual Start rendering skips it. Screen transitions are used when automatic or manual screen changes happen.",
      ...
      remoteSecurity:"Remote Deck security",saveRemoteSecurity:"Save security",
      enableRemoteDeck:"Enable Remote Deck server",
      enableRemoteAuthentication:"Require username and password",remoteUsername:"Username",
      remotePassword:"New password",remotePasswordHint:"Leave the password empty to keep the current password.",
      remoteSecuritySaved:"Remote Deck security saved.",
      ...
      addSuperWidget:"+ Super Widget",superWidget:"Super Widget",widgets:"Widgets",superWidgets:"Super Widgets",
      importSuperWidget:"Import component",superWidgetInstalled:"Installed “{name}”",
      temperatureSource:"Temperature source",fanSource:"Fan source",widgetBackground:"Widget background",backgroundAlpha:"Background alpha",
      ...
      widgetWeatherTemperature:"Weather temperature",widgetWeatherHumidity:"Weather humidity",
      widgetWeatherWind:"Weather wind",widgetWeatherCondition:"Weather condition",
      widgetWeatherIcon:"Weather icon",
      widgetSuperWidget:"Super Widget",
      ...
      selectNewScreen:"New screen name:",saveScreenName:"Save screen as:",screenSaved:"Screen “{name}” saved",screenLoaded:"Screen “{name}” loaded",
      shareSaved:"Share files saved: {package} and {preview}",
    ...
    it: {
      language:"Lingua",editor:"Editor",setup:"Impostazioni",loading:"Caricamento…",startRendering:"Avvia rendering",stopRendering:"Ferma rendering",
      ...
      currentConfiguration:"Configurazione corrente",selectScreen:"Seleziona uno screen…",load:"Carica",save:"Salva",saveAs:"Salva come",
      saveCurrentScreen:"Salva lo screen corrente",saveAsNewScreen:"Salva come nuovo screen",
      new:"Nuovo",delete:"Elimina",importPackage:"Importa pacchetto",exportPackage:"Esporta pacchetto",sharePackage:"Condividi",
      quickScreens:"Screen rapidi",comPort:"Porta COM",comPlaceholder:"AUTO oppure COM3",refreshPorts:"Aggiorna porte COM",
      layers:"Livelli",undo:"Annulla",redo:"Ripeti",group:"Raggruppa",ungroup:"Separa",
      editorName:"Nome editor",locked:"Bloccato",visible:"Visibile",moveForward:"Porta avanti",moveBackward:"Porta indietro",
      weather:"Meteo",enableWeather:"Abilita dati meteo",latitude:"Latitudine",longitude:"Longitudine",weatherRefresh:"Aggiornamento (minuti)",
      weatherHint:"Le condizioni attuali vengono memorizzate in cache. Usa coordinate in gradi decimali.",
      ...
      premiumEffects:"Effetti premium",enableBootAnimation:"Abilita boot animation",bootAnimation:"Boot animation",
      bootScreen:"Boot screen",bootHold:"Pausa boot screen (ms)",
      bootForge:"Nucleo forge",bootScanlines:"Scanline",bootFade:"Dissolvenza",bootDuration:"Durata boot (ms)",
      premiumEffectsHint:"La boot animation parte solo all’avvio automatico con Windows. Avvia rendering manuale la salta. Le transizioni vengono usate nei cambi screen automatici o manuali.",
      ...
      remoteSecurity:"Sicurezza Remote Deck",saveRemoteSecurity:"Salva sicurezza",
      enableRemoteDeck:"Abilita server Remote Deck",
      enableRemoteAuthentication:"Richiedi username e password",remoteUsername:"Username",
      remotePassword:"Nuova password",remotePasswordHint:"Lascia vuota la password per mantenere quella corrente.",
      remoteSecuritySaved:"Sicurezza Remote Deck salvata.",
      ...
      addSuperWidget:"+ Super Widget",superWidget:"Super Widget",widgets:"Widget",superWidgets:"Super Widget",
      importSuperWidget:"Importa componente",superWidgetInstalled:"Installato “{name}”",
      temperatureSource:"Sorgente temperatura",fanSource:"Sorgente ventola",widgetBackground:"Sfondo widget",backgroundAlpha:"Alpha sfondo",
      ...
      widgetWeatherTemperature:"Temperatura meteo",widgetWeatherHumidity:"Umidità meteo",
      widgetWeatherWind:"Vento meteo",widgetWeatherCondition:"Condizione meteo",
      widgetWeatherIcon:"Icona meteo",
      widgetSuperWidget:"Super Widget",
      ...
      selectNewScreen:"Nome del nuovo screen:",saveScreenName:"Salva lo screen con nome:",screenSaved:"Screen “{name}” salvato",screenLoaded:"Screen “{name}” caricato",
      shareSaved:"File condivisione salvati: {package} e {preview}",
